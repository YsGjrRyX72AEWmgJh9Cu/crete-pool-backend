...
namespace HellenicAmericanPoolHistory.Application.Tests.Features.Tournaments.StartTournament;

public sealed class StartTournamentHandlerTests
{
    [Fact]
    public async Task Handle_Should_Call_Port_With_Tournament_Id()
    {
        ...
        var port = new FakeStartTournamentPort();

        var handler = new StartTournamentHandler(port);
    ...
    private sealed class FakeStartTournamentPort
        : IStartTournamentPort
    {
        private readonly Exception? _exception;

        public FakeStartTournamentPort(
