...
namespace HellenicAmericanPoolHistory.Application.Tests.Features.Tournaments.ScheduleTournament;

public sealed class ScheduleTournamentHandlerTests
{
    [Fact]
    public async Task Handle_Should_Call_Port_With_Tournament_Id()
    {
        ...
        var port = new FakeScheduleTournamentPort();
        var handler = new ScheduleTournamentHandler(port);
    ...
    private sealed class FakeScheduleTournamentPort
        : IScheduleTournamentPort
    {
        private readonly Exception? _exception;

        public FakeScheduleTournamentPort(
