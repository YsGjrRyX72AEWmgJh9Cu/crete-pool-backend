...
| AI-004 | Open | Medium | Evaluate the introduction of a Player Status Value Object to standardize administrative player states across the Domain Model. | CE-001, GOV-008 | v1.1 |
